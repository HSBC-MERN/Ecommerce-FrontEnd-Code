...
export const ViewProducts = () => {
  ...
  const fetchProducts = async () => {
    const response = await axios.get("https://ecommerce-backend-code-w5yc.onrender.com/api/get-products");
  ...
  const handleDelete = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `https://ecommerce-backend-code-w5yc.onrender.com/api/delete-product/${id}`,
      );
